...
<label>
  ...
  <div className="flex py-3 px-5 flex-col bg-green-800 rounded-[9px] shadow-sm text-white text-xs border border-secondary font-semibold leading-4 items-center justify-center cursor-pointer transition-all duration-700 hover:bg-white hover:text-green-800 hover:transition-all hover:duration-700 focus:outline-none">{children}</div>
    ...
    className={"block autoFill px-2.5 pb-2.5 pt-4 w-full font-serif text-2xl text-heading bg-transparent rounded-base border-3 border-green-900 border-default-medium appearance-none focus:outline-none  peer h-14 rounded-[9px] pl-3 font-medium text-green-600" + outlineRing}
    />
    ...
    <label className="inline-flex items-center select-none cursor-text absolute text-2xl text-body duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-left bg-[#D9E4DD] px-2 peer-focus:px-2 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1 text-green-700 font-serif font-semibold ml-2 " htmlFor={id}>{children}</label>
    ...
    <label className="inline-flex items-center select-none cursor-text absolute text-body duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-left bg-[#D9E4DD] px-2 peer-focus:px-2 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1 text-green-700 font-serif text-2xl font-semibold ml-2 " htmlFor={id}>{children}</label>
    </div>
