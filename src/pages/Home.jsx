...
function Home() {
  ...
  return (
    <>
              ...
              productData.map(function ({
                ...
                return (
                  <Item
                    category={category}
                    name={title}
                    imgUrl={`https://rrr-frontend.onrender.com/${thumbnail}`}
      ...
      <DetailCard
        detailCard={{
          imgUrl: `https://rrr-frontend.onrender.com/${detailCard.thumbnail}`,
          imgUrl2: `https://rrr-frontend.onrender.com/${detailCard.images}`,
